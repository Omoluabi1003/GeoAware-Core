...
Ariyo AI Studio albums are the first required GeoAudio Channel source. Each Ariyo album should appear as a selectable Lagos, Nigeria-anchored channel with `sourceType: geoaudio`, album-level identity, and track-level playback metadata. See `products/waveatlas/ARIYO_GEOAUDIO_CHANNELS.md` for the adapter contract.
